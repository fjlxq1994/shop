				...
				TabBarList:[
					{
						index: 0,
						name: '首页',
						img: this.$basePath + '/static/tabBar/tab_01.png',
						acImg: this.$basePath + '/static/tabBar/tab_02.png'
					},
					{
						index: 1,
						name: '分类',
						img: this.$basePath + '/static/tabBar/tab_03.png',
						acImg: this.$basePath + '/static/tabBar/tab_04.png'
					},
					// {
					// 	index: 2,
					// 	name: '发现',
					...
					// },
					{
						index: 2,
						name: '爆款',
						img: this.$basePath + '/static/tabBar/tab_11.png',
						acImg: this.$basePath + '/static/tabBar/tab_12.png'
					},
				],
				codeheight: 0,
				isOverall: 0,
