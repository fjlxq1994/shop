<template>
		...
		<view class="head-info">
			...
			<view class="head-search">
				...
				<view class="search" @click="onSearch">
					<view class="icon">
						<image :src="$basePath+'/static/fdj_ico.png'" mode=""></image>
					</view>
					<view class="hint">
						<text class="min">搜索</text>
    ...
    <mescroll-body ref="mescrollRef"
		...
		<view class="main" v-show="classifyShow===0">
			...
			<!-- 菜单导航 -->
			<view class="menu-nav">
				<scroll-view scroll-x @scroll="ScrollMenu" class="type-nav-list">
					<view class="nav" ref="nav" :style="typeNavList.length<=10?'flex-direction:row':''">
						<view class="list" v-for="(item,index) in typeNavList"
						@click="onSkip('menu')"
						:key="item.id">
							<image :src="$basePath+'/static/nav/type/'+item.id+'.png'" mode=""></image>
							<text>{{item.name}}</text>
						</view>
					</view>
				</scroll-view>
				<view class="section-title">产品分类</view>
				<scroll-view scroll-x @scroll="ScrollMenu" class="category-nav-list">
					<view class="nav" ref="nav" :style="categoryNavList.length<=10?'flex-direction:row':''">
						<view class="list" v-for="(item,index) in categoryNavList"
						@click="onSkip('menu')"
						:key="item.id">
							<image :src="$basePath+'/static/nav/category/'+item.id+'.png'" mode=""></image>
							<text>{{item.name}}</text>
						</view>
					</view>
				</scroll-view>
<!-- 				<view class="indicator" v-if="navList.length>10">
			...
			<view class="recommend-info">
				<view class="recommend-title">
					<view class="title">
						<image :src="$basePath+'/static/wntj_title.png'" mode=""></image>
					</view>
				</view>
				<view class="goods-list">
					<view class="list" v-for="(item,index) in goodsList" @click="onSkip('goods')" :key="index">
						...
						<view class="price-info">
							...
							<view class="vip-price">
								<image :src="$basePath+'/static/vip_ico.png'"></image>
			...
			swiperList: [
				{
					id: 0,
					type: 'image',
					url: this.$basePath+'/static/img/banner_01.png'
				},
				{
					id: 1,
					type: 'image',
					url: this.$basePath+'/static/img/banner_02.png'
				},
				{
					id: 2,
					type: 'image',
					url: this.$basePath+'/static/img/banner_03.png'
				},
				{
					id: 3,
					type: 'image',
					url: this.$basePath+'/static/img/banner_04.png'
				},
				{
					id: 4,
					type: 'image',
			...
			goodsList:[
				{
					...
					price: '219.00',
					vip_price: '129.00',
					img: this.$basePath+'/static/img/goods_thumb_01.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '139.00',
					vip_price: '99.00',
					img: this.$basePath+'/static/img/goods_thumb_02.png',
					is_goods: 1,
				},{
					id: 1,
					...
					price: '168.00',
					vip_price: '158.00',
					img: this.$basePath+'/static/img/goods_thumb_03.png',
					is_goods: 1,
				},{
					id: 1,
					...
					price: '68.00',
					vip_price: '36.00',
					img: this.$basePath+'/static/img/goods_thumb_04.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '68.00',
					vip_price: '59.00',
					img: this.$basePath+'/static/img/goods_thumb_05.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '83.00',
					vip_price: '78.00',
					img: this.$basePath+'/static/img/goods_thumb_06.png',
					is_goods: 1,
				},{
					id: 1,
					...
					price: '68.00',
					vip_price: '48.00',
					img: this.$basePath+'/static/img/goods_thumb_07.png',
					is_goods: 1,
				},{
					id: 1,
					...
					price: '29.00',
					vip_price: '19.00',
					img: this.$basePath+'/static/img/goods_thumb_08.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '168.00',
					vip_price: '160.00',
					img: this.$basePath+'/static/img/goods_thumb_09.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '89.00',
					vip_price: '78.00',
					img: this.$basePath+'/static/img/goods_thumb_10.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '1190.00',
					vip_price: '1100.00',
					img: this.$basePath+'/static/img/goods_thumb_11.png',
					is_goods: 0,
				},{
					id: 1,
					name: '小米（MI） Redmi 8A',
					price: '699.00',
					vip_price: '599.00',
					img: this.$basePath+'/static/img/goods_thumb_12.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '5899.00',
					vip_price: '5800.00',
					img: this.$basePath+'/static/img/goods_thumb_13.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '3699.00',
					vip_price: '3600.00',
					img: this.$basePath+'/static/img/goods_thumb_14.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '4888.00',
					vip_price: '4999.00',
					img: this.$basePath+'/static/img/goods_thumb_15.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '4888.00',
					vip_price: '3600.00',
					img: this.$basePath+'/static/img/goods_thumb_16.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '18200.00',
					vip_price: '18200.00',
					img: this.$basePath+'/static/img/goods_thumb_17.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '8299.00',
					vip_price: '8200.00',
					img: this.$basePath+'/static/img/goods_thumb_18.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '288.00',
					vip_price: '282.00',
					img: this.$basePath+'/static/img/goods_thumb_19.png',
					is_goods: 0,
				},{
					id: 1,
					...
					price: '188.00',
					vip_price: '99.00',
					img: this.$basePath+'/static/img/goods_thumb_20.png',
					is_goods: 0,
				},
			],
			classifyShow: 0,
