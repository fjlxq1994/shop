          ...
          <view class="content">
            ...
            <view class="thumb-list">
              <view class="video-info" @click="isVideoShow = true">
                <image :src="$basePath + '/static/img/goods_thumb_09.png'" class="picture"></image>
                <view class="shade">
              ...
              <view class="list" v-for="(value,idx) in 8"
                    ...
                    :key="idx">
                <image :src="$basePath + '/static/img/goods_thumb_0'+(idx+1)+'.png'"></image>
              </view>
            </view>
          </view>
        </view>
...
export default {
  data() {
    return {
      isVideoShow: false,
      urls: [
        this.$basePath + '/static/img/yf_02.jpg',
        this.$basePath + '/static/img/wen_01.jpg',
        this.$basePath + '/static/img/class_01.jpg',
        this.$basePath + '/static/img/yf_01.png'
      ],
      videoContext: '',
    };
  },
