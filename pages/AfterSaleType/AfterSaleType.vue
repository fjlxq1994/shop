	...
	<view class="page">
		...
		<view class="goods-data">
			<view class="goods-list">
				<view class="list">
					<view class="thumb">
						<image :src="$basePath + '/static/img/souji.webp'" mode=""></image>
					</view>
					<view class="item">
						<view class="title">
		...
		<view class="type-select">
			<view class="type-list">
				<view class="list" @click="onReturnType(0)">
					<view class="title">
						<image :src="$basePath + '/static/sale_tk.png'" mode=""></image>
						<text>退款</text>
					</view>
					<view class="content">
						<text>申请商品的退款</text>
				...
				<view class="list" @click="onReturnType(1)">
					<view class="title">
						<image :src="$basePath + '/static/sale_th.png'" mode=""></image>
						<text>退货</text>
					</view>
					<view class="content">
						<text>申请商品的退货</text>
				...
				<view class="list" @click="onReturnType(2)">
					<view class="title">
						<image :src="$basePath + '/static/sale_hh.png'" mode=""></image>
						<text>换货</text>
					</view>
					<view class="content">
						<text>申请商品的换货</text>
