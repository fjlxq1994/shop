    ...
    <view class="evaluate-data" ref="evaluate">
      ...
      <view class="evaluate-list">
        <view class="user-info">
          <view class="thumb">
            <image :src="$basePath + '/static/img/user_pic.jpg'" mode=""></image>
          </view>
        ...
        <view class="content">
          ...
          <view class="thumb-list">
            <view class="list">
              <image :src="$basePath + '/static/img/goods_banner_01.webp'" mode=""></image>
            </view>
            <view class="list">
              <image :src="$basePath + '/static/img/goods_banner_02.webp'" mode=""></image>
            </view>
            <view class="list">
              <image :src="$basePath + '/static/img/goods_banner_03.webp'" mode=""></image>
            </view>
          </view>
        </view>
    ...
    <view class="ranking-list">
      ...
      <view class="goods-list">
        <view class="list" v-for="(item, index) in 6" :key="index">
          <view class="thumb">
            <image :src="$basePath + '/static/img/goods_thumb_0'+(index+1)+'.png'"></image>
          </view>
          <view class="title">
      ...
      swiperList: [
        {
          id: 0,
          type: 'image',
          url: this.$basePath + '/static/img/goods_banner_01.webp'
        },
        {
          id: 1,
          type: 'image',
          url: this.$basePath + '/static/img/goods_banner_02.webp'
        },
        {
          id: 2,
          type: 'image',
          url: this.$basePath + '/static/img/goods_banner_03.webp'
        },
        {
          id: 3,
          type: 'image',
          url: this.$basePath + '/static/img/goods_banner_04.webp'
        },
        {
          id: 4,
          type: 'image',
          url: this.$basePath + '/static/img/goods_banner_05.webp'
        },
      ],
      web_content:
